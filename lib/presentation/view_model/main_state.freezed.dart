...
abstract class $MainStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<ImageModel> images, bool isLoading});
}
...
class _$MainStateImpl with DiagnosticableTreeMixin implements _MainState {
  const _$MainStateImpl(
      {final List<ImageModel> images = const [], this.isLoading = false})
      : _images = images;
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'MainState(images: $images, isLoading: $isLoading)';
  }
...
abstract class _MainState implements MainState {
  const factory _MainState(
      {final List<ImageModel> images, final bool isLoading}) = _$MainStateImpl;
